...
CREATE OR REPLACE FUNCTION handlebars_compile(template TEXT, file TEXT, flags int8 default 0) RETURNS BOOL AS 'MODULE_PATHNAME', 'pg_handlebars_compile' LANGUAGE 'c';
...
CREATE OR REPLACE FUNCTION handlebars_execute(json JSON, template TEXT, file TEXT, flags int8 default 0, convert bool default true, run int8 default 1) RETURNS BOOL AS 'MODULE_PATHNAME', 'pg_handlebars_execute' LANGUAGE 'c';
...
CREATE OR REPLACE FUNCTION handlebars_lex(template TEXT, file TEXT, flags int8 default 0) RETURNS BOOL AS 'MODULE_PATHNAME', 'pg_handlebars_lex' LANGUAGE 'c';
...
CREATE OR REPLACE FUNCTION handlebars_module(template TEXT, file TEXT, flags int8 default 0, pretty bool default true) RETURNS BOOL AS 'MODULE_PATHNAME', 'pg_handlebars_module' LANGUAGE 'c';
...
CREATE OR REPLACE FUNCTION handlebars_parse(template TEXT, file TEXT, flags int8 default 0) RETURNS BOOL AS 'MODULE_PATHNAME', 'pg_handlebars_parse' LANGUAGE 'c';
