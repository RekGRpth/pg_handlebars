...
CREATE OR REPLACE FUNCTION handlebars_module(template TEXT, flags int8 default 0, pretty bool default true, file TEXT) RETURNS BOOL AS 'MODULE_PATHNAME', 'pg_handlebars_module' LANGUAGE 'c';
...
CREATE OR REPLACE FUNCTION handlebars_parse(template TEXT, flags int8 default 0, file TEXT) RETURNS BOOL AS 'MODULE_PATHNAME', 'pg_handlebars_parse' LANGUAGE 'c';
